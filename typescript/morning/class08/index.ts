// write a ts program, that calculate sum of numbers that divisble by 5 between 1 - 100, and list all that particapte in sum calculation, print the list along sum
let sum:number = 2;
let list:number[] = []
for(let i=1; i<=100; i++){
  if (i%5 == 0) {
